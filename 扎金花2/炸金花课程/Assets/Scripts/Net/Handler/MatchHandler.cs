...
public class MatchHandler : BaseHandler
{
    public override void OnReceive(int subCode, object value)
    {
        switch (subCode)
        {
            case MatchCode.Enter_SRES:
                 EnterRoomSRES(value as MatchRoomDto2);
                //EnterRoomSRES((MatchCode)value);
                break;
    ...
    private void EnterRoomSRES(MatchRoomDto2 dto)
    {
    ...
    {
        MatchRoomDto2 dto = Models.GameModel.matchRoomDto;
