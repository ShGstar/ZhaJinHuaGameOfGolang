...
public class LeftManager_Net : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventCenter.AddListener<PlayerDto>(EventDefine.LeftDealCard, DealCard);
    ...
    private void OnDestroy()
    {
        ...
        EventCenter.RemoveListener<PlayerDto>(EventDefine.LeftDealCard, DealCard);
    ...
    private void DealCard(PlayerDto player)
    {
        ...
        {
            DealCard(0.3f, new Vector3(566.6f, -40.89f, 0));
        }
    }
    /// <summary>
    /// 发牌
    ...
    {
        MatchRoomDto2 room = Models.GameModel.matchRoomDto;
